...
module.exports = function(name) {
  let file = [
    process.env.CONFIG_PATH + "initialisers/" + name,
    process.cwd() + "/node_modules/" + name,
  ];

  if (!fs.existsSync(file[0] + ".js") || fs.existsSync(file[0] + ".json")) c.red("\tInitializer " + name + " [js/json] not found, add it on /config/initialisers");
